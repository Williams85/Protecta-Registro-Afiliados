...
Partial Class ProcesosCAFAE
    ...
    Private Sub mCargaTitulo()
        ...
        sTipoMov = Session("CAFAE").ToString

        If sTipoMov = "VIG" Then
            lblTipoMovimiento.Text = "VIGENTES"
        ElseIf sTipoMov = "VEN" Then
            lblTipoMovimiento.Text = "VENCIDOS"
        End If
    End Sub
            ...
            If ddlCanal.SelectedIndex > 0 And ddlProducto.SelectedIndex > 0 And ddlPoliza.SelectedIndex > 0 Then
                ...
                Try
                    ...
                    Else
                        ...
                        TipFormato = Session("CAFAE").ToString
                        dtformato = Metodos.Lista_Datos_Formato_CAFAE(Metodos.DB.ORACLE, ddlCanal.SelectedValue, ddlProducto.SelectedValue, ddlPoliza.SelectedValue, periodo, ciclo, TipFormato)
                        Session("DATOS_FORMATO") = dtformato
                        dtArchivo = Metodos.Lista_Datos_Archivo_CAFAE(Metodos.DB.ORACLE, ddlCanal.SelectedValue, ddlProducto.SelectedValue, ddlPoliza.SelectedValue, ddlCiclo.Text.Substring(0, 4) & ddlCiclo.Text.Substring(4, 2), ciclo)
                        ...
                        Select Case ESTADO
                            ...
                            Case "C"
                                ...
                                'txtReg2.Text = Metodos.Lista_Tabla_Canal(Metodos.DB.ORACLE, vtabla).Compute("count(NUM_FILA)", "")
                                txtReg2.Text = Metodos.Lista_Tabla_Canal_CAFAE(Metodos.DB.ORACLE, vtabla).ToString
                                txtAño2.ReadOnly = True
                                txtMes2.ReadOnly = True
                                txtCiclo2.ReadOnly = True
                                txtReg2.ReadOnly = True
                                btnProcesarPaso1.Enabled = False
                                Dim DTf As DataTable = Metodos.Lista_Tabla_fechas_policy_CAFAE(Metodos.DB.ORACLE, TipFormato, ddlProducto.SelectedValue)
                                txtAñoProceso.Text = Year(Convert.ToDateTime(DTf.Rows(0).Item(0).ToString))
                                ddlMesProceso.SelectedValue = String.Format("{0:00}", Month(Convert.ToDateTime(DTf.Rows(0).Item(0).ToString)))
                                txtAñoProceso.ReadOnly = True
                                ddlMesProceso.Enabled = False
                            Case "G"
                                vPaso = 3
                                ...
                                txtReg3.Text = Metodos.Lista_Tabla_Pol_CAFAE(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, ddlProducto.SelectedValue, TipFormato).Compute("count(NUM_FILA)", "")
                ...
                End Try
            Else
                AlertaScripts("Debe seleccionar CANAL, PRODUCTO para seguir con la carga.")
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Protected Sub btnSiguiente_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSiguiente.Click
        ...
        Try
            ...
            txtAñoProceso.Text = Date.Now.Year
            ddlMesProceso.SelectedValue = Date.Now.Month.ToString.PadLeft(2, "0")

            Dim iRegistros As Integer
            Dim vtabla As String = dtformato.Tables(0).Rows(0).Item("Tabla").ToString
            iRegistros = Metodos.Lista_Tabla_Canal_CAFAE(Metodos.DB.ORACLE, vtabla)
            Dim vCantCorrec As Int64 = iRegistros 'dt.Compute("count(NUM_FILA)", "")
            ...
            If sTipoMov = "VIG" Then
                ddlMesProceso.Visible = True
                txtAñoProceso.Visible = True
                lblAñoProceso.Visible = True
                lblMesProceso.Visible = True
                lblFecProceso.Visible = True
            Else
                ddlMesProceso.Visible = False
                txtAñoProceso.Visible = False
                lblAñoProceso.Visible = False
                lblFecProceso.Visible = False
                lblMesProceso.Visible = False
            End If
            CerrarEspera()
        ...
        Catch ex As Exception
            AlertaScripts("Ocurrio un Error: " & ex.Message)
        End Try
    End Sub
    ...
    Protected Sub btnSiguientePaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSiguientePaso1.Click
        ...
        Try
            ...
            If sTipoMov = "VIG" Then
                ...
                btnRegxModPaso3.Text = "CAFAE Vigentes"
            ElseIf sTipoMov = "VEN" Then
                btnRegxModPaso3.Visible = True
                btnRegxModPaso3.Text = "CAFAE Vencidos"
            Else
            ...
            Dim sTipFormato As String = Session("CAFAE").ToString
            txtReg3.Text = Metodos.Lista_Tabla_Pol_CAFAE(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, ddlProducto.SelectedValue, sTipFormato).Compute("count(NUM_REGISTRO)", "")
    ...
    Protected Sub btnProcesar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
        ...
        Try
            ...
            'SvalFecha = Metodos.Validar_Fecha_Efecto(Metodos.DB.ORACLE, sFechaEfecto, "", ddlProducto.SelectedValue, ddlPoliza.SelectedValue)
            ...
            If FileUpload1.PostedFile.FileName.ToString <> "" And txtCabecera.Text.Trim <> "" Then
                ...
                sTipFormato = Session("CAFAE").ToString 'ddlTipoFormato.SelectedValue
                nCiclo = Metodos.Abre_Ciclo_CAFAE(Metodos.DB.ORACLE, ddlCanal.SelectedValue, ddlProducto.SelectedValue, ddlPoliza.SelectedValue, txtAño.Text.Trim & ddlMeses.Text, txtComentario.Text.Trim, sArchivoOrigen, txtCabecera.Text, txtComentario.Text.Trim, sTipFormato)
                System.Threading.Thread.Sleep(500)
                dtArchivo = Metodos.Lista_Datos_Archivo_CAFAE(Metodos.DB.ORACLE, ddlCanal.SelectedValue, ddlProducto.SelectedValue, ddlPoliza.SelectedValue, txtAño.Text.Trim & ddlMeses.Text, nCiclo)
                ...
                dtformato = Metodos.Lista_Datos_Formato_CAFAE(Metodos.DB.ORACLE, ddlCanal.SelectedValue, ddlProducto.SelectedValue, ddlPoliza.SelectedValue, txtAño.Text.Trim & ddlMeses.Text, sCiclo, sTipFormato)
...
salto:
    ...
    Private Sub CreaArchivoCTL(ByVal sPeriodo As String, ByVal sSecPol As Integer)
        ...
        Try
            ...
            Next
            str.AppendLine(",")
            str.AppendLine("   NUM_FILA    ""seq_trx_in_" & vFormato & ".nextval""")
            str.AppendLine(")")
            texto = str.ToString
    ...
    Protected Sub btnProcesarPaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcesarPaso1.Click
        Try
            ...
            sFechaProceso = "01/" & ddlMesProceso.Text & "/" & txtAñoProceso.Text.Trim
            sTipoMov = Session("CAFAE").ToString
            dtArchivo = Session("DATOS_ARCHIVO")
            dtformato = Session("DATOS_FORMATO")

            fecha = Convert.ToDateTime(sFechaProceso)
            If sTipoMov = "VIG" And fecha > Date.Now() Then
                AlertaScripts("No debe ingresar una Fecha de Proceso Futura")
                boolFecha = False
            End If
            ...
            If boolFecha Then
                ...
                Metodos.Inserta_errores_CAFAE(Metodos.DB.ORACLE, NumArchivo, vConsistencia, sFechaProceso)

                Call EstadoPasosProc(2)

                'inserta en tabla tbl_trx_exclusion y tbl_trx_pol#poliza
                Metodos.Traslado_Registros(Metodos.DB.ORACLE, NumArchivo, vTranslada)
                'ACTUALIZA ESTADO
    ...
    Protected Sub btnProcesarPaso3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProcesarPaso3.Click
        ...
        Try
            ...
            'SvalFecha = Metodos.Validar_Fecha_Efecto(Metodos.DB.ORACLE, sFechaEfecto, sTipoMov, ddlProducto.SelectedValue, ddlPoliza.SelectedValue)
            'If SvalFecha = "FECHA CORRECTA" Then
    ...
    Protected Function mMensajeProceso() As String
        ...
        If sTipoMov = "VIG" Then
            MsgProceso = "Este proceso cargará la Póliza " & ddlPoliza.SelectedValue & " del Producto " & ddlProducto.SelectedItem.Text & ". ¿Desea Procesar?"
        ElseIf sTipoMov = "VEN" Then
            MsgProceso = "Este proceso cargará la Póliza " & ddlPoliza.SelectedValue & " del Producto " & ddlProducto.SelectedItem.Text & ". ¿Desea Procesar?"
        End If
    ...
    Protected Sub imbCancelar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbCancelar.Click
        ...
        ddlMesProceso.Enabled = True
        txtAñoProceso.ReadOnly = False
    ...
    Protected Sub btnRegCorrectos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegCorrectos.Click
        Try
            ...
            Dim sTipoMov As String = Session("CAFAE").ToString
            ...
            x(3) = "Poliza;" & ddlPoliza.SelectedItem.Text
            x(4) = "ciclo;" & sPeriodo & "-" & sCiclo
            x(5) = "Archivo;" & sNumArchivo
            x(6) = "RutaArchivo;" & txtRuta.Text
            x(7) = "Titulo;" & lblTipoMovimiento.Text

            dt = Metodos.Lista_Report_Correctos_CAFAE(Metodos.DB.ORACLE, vtabla)
            Session("TABLA_REPORTE") = dt
            If sTipoMov = "VIG" Then
                Session("RPT") = "Paso1_Detallado_Vigente.rpt"
            ElseIf sTipoMov = "VEN" Then
                Session("RPT") = "Paso1_Detallado_Vencido.rpt"
            End If
    ...
    Protected Sub btnResTotal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResTotal.Click
        Try
            ...
            Session("TABLA_REPORTE") = dt
            Session("RPT") = "Paso1_Resumido_CAFAE.rpt"
            Session("NombreRPT") = "Detallado"
            ...
            x(5) = "Poliza;" & ddlPoliza.SelectedItem.Text
    ...
    Protected Sub btnProblemas_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnProblemas.Click
        ...
        Try
            ...
            Session("RPT") = "Paso1_Carga_CAFAE.rpt"
    ...
    Protected Sub btnErroresPaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnErroresPaso1.Click
        Try
            ...
            Session("TABLA_REPORTE") = dt
            Session("RPT") = "Paso2_Errores_CAFAE.rpt"
    ...
    Protected Sub btnWarningPaso1_Click(sender As Object, e As EventArgs) Handles btnWarningPaso1.Click
        Try
            Dim dt As DataTable
            dtArchivo = Session("DATOS_ARCHIVO")
            Dim sNroArchivo As Integer = dtArchivo.Rows(0).Item("Num_Archivo").ToString
            ...
            dt = Metodos.Lista_Report_Warning(Metodos.DB.ORACLE, sNroArchivo)
    ...
    Protected Sub btnCorrectosPaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCorrectosPaso1.Click
        Try
            ...
            dt = Metodos.Lista_Tabla_Pol_CAFAE(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, ddlProducto.SelectedValue, sTipFormato)

            Session("TABLA_REPORTE") = dt
            If sTipoMov = "VIG" Then
                Session("RPT") = "Paso2_Transferidos_Vigente.rpt"
            ElseIf sTipoMov = "VEN" Then
                Session("RPT") = "Paso2_Transferidos_Vencido.rpt"
            End If
    ...
    Protected Sub btnResumenPaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnResumenPaso1.Click
        ...
        Try
            ...
            dt = Metodos.Lista_Report_Resumen_CAFAE(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, vTabla, vArchivo, sTipFormato)

            Session("TABLA_REPORTE") = dt
            Session("RPT") = "Paso2_Resumen_CAFAE.rpt"
    ...
    Protected Sub btnRegxModPaso3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegxModPaso3.Click
        ...
        Try
            ...
            dt = Metodos.Lista_Procesados_CAFAE(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, ddlProducto.SelectedValue, sTipFormato)
            ...
            Session("TABLA_REPORTE") = dt
            Session("RPT") = "Paso3_Modulos_CAFAE.rpt"
    ...
    Protected Sub imbAceptarCarga_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbAceptarCarga.Click
        ...
        Call Remplazo_Nomina_94()

    End Sub

    Private Sub Remplazo_Nomina_94()
        Try
            Dim DT As DataTable
            Dim sPeriodo As String = ""
            Dim sCiclo As Integer = 0
            ...
            Dim año As String = Year(Date.Now()) 'txtFechaDef.Text.Substring(6, 4)
            Dim mes As String = String.Format("{0:00}", Month(Date.Now())) 'txtFechaDef.Text.Substring(3, 2)
            Dim dia As String = String.Format("{0:00}", Day(Date.Now())) 'txtFechaDef.Text.Substring(0, 2)

            sEstadoJob = Metodos.Archivo_Genera_Tarea(Metodos.DB.ORACLE, ddlPoliza.SelectedValue, Session("CodUsuario"), año & mes & dia, vTransformada, "C")
            CerrarEspera()
