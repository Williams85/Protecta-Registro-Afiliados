<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" 
    CodeFile="ActualizaciondatosSusalud.aspx.vb" Inherits="ActualizaciondatosSusalud" Title="Actualizacion datos Susalud" Theme="Tema" %>
    ...
    <table id="TABLE1" style="width: 100%; border-top-style: groove; border-right-style: groove;
        ...
        <tr>
            <td align="left" style="height: 21px" colspan="4" >
                <asp:Label ID="txtTitulo0" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11pt"
                    ForeColor="Green">Reporte validación:</asp:Label></td>
        </tr>
        <tr>
            <td align="left" style="height: 36px" >
                <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                    Text="Fecha Inicio Proceso:"></asp:Label></td>
            <td align="left" style="height: 36px" >
                <asp:TextBox ID="txFechaEfectoInicio" runat="server" Width="93px"></asp:TextBox>
                <asp:ImageButton ID="imabtncalendarioInicio" runat="server" ImageUrl="~/Imagenes/calendario.jpg" Height="18px" />
                <asp:Calendar ID="CalendarioInicio" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="200px" ShowGridLines="True" Width="220px">
            ...
            <td align="Rigth" style="height: 36px" >
                <asp:Label ID="Label19" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                    Text="Fecha Fin Proceso:"></asp:Label>
            </td>
            <td align="left" style="height: 36px" >
                <asp:TextBox ID="txFechaEfectoFin" runat="server" Width="93px"></asp:TextBox>
                <asp:ImageButton ID="imabtncalendarioFin" runat="server" ImageUrl="~/Imagenes/calendario.jpg" />
                <asp:Calendar ID="CalendarioFin" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="200px" ShowGridLines="True" Width="220px">
                    <DayHeaderStyle BackColor="#FFCC66" Font-Bold="True" Height="1px" />
                    <NextPrevStyle Font-Size="9pt" ForeColor="#FFFFCC" />
                    <OtherMonthDayStyle ForeColor="#CC9966" />
                    <SelectedDayStyle BackColor="#CCCCFF" Font-Bold="True" />
            ...
            <td align="right" style="height: 36px" >
                <asp:Button ID="BtnExportarExcel" runat="server" Text="Exportar a Excel" Width="138px" />
                </td>
        </tr>
        <tr>
            <td align="left" style="height: 21px" colspan="4" >
        ...
        <tr>
            <td align="left" style="height: 36px" colspan="4" >
                ...
                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    <asp:View ID="View1" runat="server">
                        <table style="width: 100%; height: 100%; background-color: gainsboro">
                            <tr>
                                <td style="width: 121px; height: 36px">
                                </td>
