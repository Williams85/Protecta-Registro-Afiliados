<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ProcesosCAFAE.aspx.vb" Inherits="ProcesosCAFAE" 
    Title="Validador de archivos CAFAE" Theme="Tema"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                    ...
                                    <table style="width: 650px; height: 100%; background-color: gainsboro; margin: 0 auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 30%; height: 26px;">
                                                <asp:Button ID="btnSiguiente" runat="server" TabIndex="6" Text="Siguiente" Width="90%" OnClientClick="MostrarEspera2();"/></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 20%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 30%; height: 27px">
                                                <asp:Button ID="btnResTotal" runat="server" TabIndex="8" Text="Resumen Total" Width="90%" OnClientClick="MostrarEspera2();"/></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td></td>
                                            <td style="width: 30%;">
                                                <asp:Button ID="btnRegCorrectos" runat="server" TabIndex="9" Text="Registros Correctos" Width="90%" OnClientClick="MostrarEspera2();" /></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td></td>
                                            <td style="width: 30%;">
                                                <asp:Button ID="btnProblemas" runat="server" Text="Error de Carga" Width="90%" OnClientClick="MostrarEspera2();" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table style="width: 650px; height: 100%; background-color: gainsboro; margin: 0 auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnSiguientePaso1" runat="server" Text="Siguiente" Width="90%" OnClientClick="MostrarEspera2();"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:27%">
                                            ...
                                            <td colspan="2"></td>
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnCerrarPaso1" runat="server" Text="Cerrar" Width="90%" OnClientClick="MostrarEspera2();"/></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 27%">
                                                <asp:Label ID="lblFecProceso" runat="server" Font-Bold="True" Font-Names="Tahoma"
                                                    Font-Size="8pt" Text="Fecha Proceso :"></asp:Label></td>
                                            <td style="width: 18%">
                                                <table width="100%">
                                                    <tr>
                                                        <td style="width:40px"> 
                                                            <asp:Label ID="lblAñoProceso" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                                                            Text="Año :"></asp:Label>
                                                        </td>
                                                        <td style="width:60px">
                                                            <asp:TextBox ID="txtAñoProceso" runat="server" Font-Bold="True" 
                                            ...
                                            <td style="width:40px">
                                                <asp:Label ID="lblMesProceso" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                                                Text="Mes :"></asp:Label>
                                            </td>
                                            <td style="width:120px">
                                                <asp:DropDownList ID="ddlMesProceso" runat="server" TabIndex="3">
                                                    <asp:ListItem Value="01">Enero</asp:ListItem>
                                                    <asp:ListItem Value="02">Febrero</asp:ListItem>
                                                    <asp:ListItem Value="03">Marzo</asp:ListItem>
                                                    <asp:ListItem Value="04">Abril</asp:ListItem>
                                            ...
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnErroresPaso1" runat="server" Text="Errores" Width="90%" OnClientClick="MostrarEspera2();"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnWarningPaso1" runat="server" Text="Warning" Width="90%" OnClientClick="MostrarEspera2();"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width: 18%"></td>
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnCorrectosPaso1" runat="server" OnClientClick="MostrarEspera2();" Text="Transferidos" Width="90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 27%"></td>
                                            ...
                                            <td style="width: 30%" align="center">
                                                <asp:Button ID="btnResumenPaso1" runat="server" OnClientClick="MostrarEspera2();" Text="Resumen" Width="90%" />
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <td>
                                    <table style="width: 650px; height: 100%; background-color: gainsboro; margin: 0 auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"></td>
                                            <td style="width: 30%">
                                                <asp:Button ID="btnCerrarPaso3" runat="server" Text="Cerrar" Width="90%" OnClientClick="MostrarEspera2();"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 27%">
                                            ...
                                            <td colspan="2"></td>
                                            <td style="width: 30%">
                                                <asp:Button ID="btnRegxModPaso3" runat="server" Text="" Width="90%" OnClientClick="MostrarEspera2();"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 27%"></td>
    ...
    <cc1:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="9999" MaskType="Number"
        TargetControlID="txtAñoProceso">
    </cc1:MaskedEditExtender>
    &nbsp; &nbsp;&nbsp;&nbsp;
