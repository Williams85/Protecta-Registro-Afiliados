<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ProcesosSCTR_Doc.aspx.vb" Inherits="ProcesosSCTR_Doc" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="position:absolute; display:none; left:0px; background-color: rgba(232, 221, 219, 0.4);" id="DivProcessMessage">
        <div style="TEXT-ALIGN: center; width: 700px; height: 100px; left: 0px; background-color:white; margin-left:20%;margin-top:15%; border: 1px; " ><b>Cargando...</b><br /><img src="imagenes/progress_rojo.gif" /><br /></div>
    </div>
                                        ...
                                        <tr>
                                            <td style="width: 27%">
                                                <asp:Label ID="lblFecEfecto0" runat="server" Font-Bold="True" Font-Names="Tahoma"
                                                    Font-Size="8pt" Text="Fecha de Efecto" Visible="false" ></asp:Label></td>
                                            <td style="width: 18%">
                                                <asp:TextBox ID="txtFecEfecto0" runat="server" Width="85%" Height="22px" Visible="false" ></asp:TextBox>
                                            </td>
