...
Partial Class LiqRecibosFam
    ...
    Private Sub CargarCombos()
        ...
        txtLiquidacion.Text = DateSerial(Year(Date.Now), Month(Date.Now), Day(Date.Now))
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        Try
            If ddlProducto.SelectedIndex > 0 And ddlPoliza.SelectedIndex > 0 Then
                ...
                dtRecibos = metodos.Lista_Recibos_Serie006(metodos.DB.ORACLE, ddlProducto.SelectedValue, ddlPoliza.SelectedValue)
                ...
                If dtRecibos.Rows.Count > 0 Then
                    ...
                    txtNumReg.Text = dtRecibos.Compute("count(CANTIDAD_RECIBOS)", "").ToString
                ...
                Else
                    ...
                    For Each row As GridViewRow In gvDetalle.Rows
                        ...
                        If cb IsNot Nothing AndAlso cb.Checked Then
                            ...
                            If txtLiquidacion.Text.Trim <> "" Then
                                If Not DateTime.TryParse(txtLiquidacion.Text, fecha) Then
                                    AlertaScripts("Debe ingresar una fecha Válida")
                                Else
                                    año = txtLiquidacion.Text.Substring(6, 4)
                                    mes = txtLiquidacion.Text.Substring(3, 2)
                                    dia = txtLiquidacion.Text.Substring(0, 2)
                                    vFechaLiquid = año & mes & dia

                                    'Validar fecha de liquidacion
                                    SvalFecha = metodos.Validar_Fecha_Liquidacion(metodos.DB.ORACLE, vFechaLiquid)
                                    If SvalFecha = "FECHA VALIDA" Then

                                        'Validar estado de la poliza
                                        SvalPoliza = metodos.Validar_Estado_Poliza(metodos.DB.ORACLE, vProducto, vPoliza)
                                        If SvalPoliza = "LIBRE" Then
                                            lblMensajeProceso.Text = "Desea generar la liquidación de  " & vCertificadoS & " Comprobantes de la Serie 006 con fecha " & txtLiquidacion.Text
                                            mpeCarga.Show()
                                        Else
                                ...
                                End If
                            Else
                                AlertaScripts("Ingresar fecha de Liquidación")
                            End If
    ...
    Protected Sub imbAceptarCarga_Click(sender As Object, e As ImageClickEventArgs) Handles imbAceptarCarga.Click
        ...
        Call Generacion_Liquidacion_Rec()
        gvDetalle.DataSource = Nothing
        gvDetalle.DataBind()
    ...
    Private Sub Generacion_Liquidacion_Rec()
        Try
            ...
            For Each row As GridViewRow In gvDetalle.Rows
                ...
                If cb IsNot Nothing AndAlso cb.Checked Then
                    ...
                    System.Threading.Thread.Sleep(500)
                    sEstadoJob = metodos.Crea_Job_Liquidacion_Recibos_Familiares(metodos.DB.ORACLE, vProducto, vPoliza, vCertificadoS, vFechaLiquid, Session("CodUsuario"))
