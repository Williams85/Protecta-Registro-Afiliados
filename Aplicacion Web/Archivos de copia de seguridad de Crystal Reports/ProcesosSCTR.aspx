<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ProcesosSCTR.aspx.vb" Inherits="ProcesosSCTR" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="TABLE1" style="width: 100%; border-top-style: groove; border-right-style: groove;
        ...
        <tr id="TipFormato" runat="server" visible="false">
            <td style="width: 517px; height: 35px">
            </td>
            <td style="width: 282px; height: 35px">
                <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="8pt"
                    Text="Formato :" Width="84px"></asp:Label>
            </td>
            <td style="height: 35px">
                <asp:DropDownList ID="ddlTipoFormato" runat="server" AutoPostBack="True" Width="120">
                </asp:DropDownList>
            </td>
                        ...
                        <table style="width: 100%; height: 100%; background-color: gainsboro">
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="height: 27px"  valign="middle">
                                    <asp:FileUpload ID="FileUpload1" runat="server" Width="303px" onChange="Seleccionar(this);"/>
                                    <asp:TextBox ID="txtRuta" runat="server" Width="295px"></asp:TextBox></td>
                                <td style="width: 86px; height: 27px" valign="middle">
                            ...
                            <tr>
                                ...
                                <td style="width: 86px">
                                    <asp:Button ID="btnProblemas" runat="server" Text="Error de Carga" Width="128px" Visible="false"/></td>
                                <td>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                ...
                                <td align="center" style="width: 110px; height: 26px">
                                    <%--<asp:Button ID="BtnPermanencia" runat="server" Text="Exceden permanencia" Width="144px"
                                        Enabled="False" Height="40px" Visible="False" />--%>
                                </td>
                                <td style="width: 100px; height: 26px">
                                </td>
                            </tr>
                    ...
                    <asp:View ID="View3" runat="server">
                        <table style="width: 100%; height: 100%; background-color: lightgrey">
                            ...
                            <tr>
                                ...
                                <td style="width: 97px">
                                    <asp:Button ID="btnSiguientePaso3" runat="server" Text="Siguiente" Width="133px" Visible="false"/></td>
                                <td style="width: 100px">
                                </td>
                            </tr>
                            <tr>
