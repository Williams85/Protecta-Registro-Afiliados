<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="LiqRecibosFam.aspx.vb" Inherits="LiqRecibosFam" Title="Liquidación de Recibos Familiares" StylesheetTheme="Tema"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
        <contenttemplate>
            ...
            <table>
                    <tr>
                        <td style="FONT-WEIGHT: bold; FONT-SIZE: large; FONT-FAMILY: Tahoma; HEIGHT: 88px; color: #000099;" align="center" colspan="9">Liquidación de Comprobantes<br /> Serie 006</td></TR><TR><TD style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-FAMILY: Tahoma; HEIGHT: 26px" colSpan="2">&nbsp;
                        </td>
                        ...
                        <td colspan="9" align="center">
                            ...
                            <PagerSettings Mode="NumericFirstLast" />
                                ...
                                <asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="CANTIDAD_RECIBOS" HeaderText="Cantidad de Recibos">
    ...
    <td style="WIDTH: 21px" colspan="3">
        ...
        <tr>
            ...
            <td colspan="1" align="right">
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="10pt" Text="Fecha de Liquidación:"></asp:Label>
                </td>
            <td style="WIDTH: 519px">
                            <asp:TextBox ID="txtLiquidacion" runat="server" Width="80px"></asp:TextBox>
                            <asp:ImageButton ID="imgCalendarFac" runat="server" ImageUrl="~/Imagenes/Calendario.jpg" />
                            <cc1:CalendarExtender ID="Calendar1" PopupButtonID="imgCalendarFac" runat="server" TargetControlID="txtLiquidacion" Format="dd/MM/yyyy">
