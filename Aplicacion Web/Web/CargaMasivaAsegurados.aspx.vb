...
Partial Class CargaMasivaAsegurados
      ...
      Try
            If (StatusSession()) Then
                ...
                If FileUpload1.PostedFile.FileName.ToString <> "" And txtCabecera.Text.Trim <> "" Then
                    ...
                    Metodos.Abre_Ciclo(Metodos.DB.ORACLE, "CARGA_ASEGURADOS", 0, 0, txtAño.Text.Trim & ddlMeses.Text, txtComentario.Text.Trim, sArchivoOrigen, txtCabecera.Text, txtComentario.Text.Trim)
                    System.Threading.Thread.Sleep(500)
                    dtArchivo = Metodos.Lista_Datos_Archivo(Metodos.DB.ORACLE, "CARGA_ASEGURADOS", 0, 0, txtAño.Text.Trim & ddlMeses.Text)
                    ...
                    dtformato = Metodos.Lista_Datos_Formato(Metodos.DB.ORACLE, "CARGA_ASEGURADOS", 0, 0, txtAño.Text.Trim & ddlMeses.Text, sCiclo)
                    ...
                    Dim ourFileGen As FileInfo = New FileInfo(RutaBat & "/bat/" & "CARGA_ASEGURADOS" & "POL" & 0 & ".bat")
                    If ourFileGen.Exists Then
                        My.Computer.FileSystem.DeleteFile(RutaBat & "/bat/" & "CARGA_ASEGURADOS" & "POL" & 0 & ".bat")
                    End If
                    ...
                    Dim sRutaDestino As String = HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".TXT"
                    ...
                    Dim ourFileCTL As FileInfo = New FileInfo(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".CTL")
                    If ourFileCTL.Exists Then
                        My.Computer.FileSystem.DeleteFile(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".CTL")
                    End If

                    Dim ourFileLOG As FileInfo = New FileInfo(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".LOG")
                    If ourFileLOG.Exists Then
                        My.Computer.FileSystem.DeleteFile(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".LOG")
                    End If

                    Dim ourFileBAD As FileInfo = New FileInfo(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".BAD")
                    If ourFileBAD.Exists Then
                        My.Computer.FileSystem.DeleteFile(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".BAD")
                    End If

                    Dim ourFileDSC As FileInfo = New FileInfo(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".DSC")
                    If ourFileDSC.Exists Then
                        My.Computer.FileSystem.DeleteFile(HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".DSC")
                    End If
   ...
   Private Sub CreaDirectorioTrabajo(ByVal sPeriodo As String)
      ...
      Try
         ...
         rUTA = HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "\PROD" & 0 & "\" & sPeriodo
         'Try
   ...
   Private Sub CreaArchivoCTL(ByVal sPeriodo As String, ByVal sSecPol As Integer)
      ...
      Try
         ...
         rut = HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".CTL"
   ...
   Private Sub CorreProceso()
      ...
      pro.StartInfo.FileName = "CARGA_ASEGURADOS" & "POL" & 0 & ".bat"
...
salto:
   ...
   Private Sub CreaBat(ByVal Periodo As String, ByVal SecPol As Integer)
      ...
      Try
         ...
         ruta = HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "\PROD" & 0 & "\" & Periodo & "\POL" & 0 & "-" & SecPol.ToString.PadLeft(2, "0")
         ...
         theFileBat = File.Open(ruta_Bat & "\bat\" & "CARGA_ASEGURADOS" & "POL" & 0 & ".bat", FileMode.OpenOrCreate, FileAccess.Write)
         Dim filaEscribebat As StreamWriter = New StreamWriter(theFileBat)
   ...
   Private Function TablaProblemasCargaInicial() As DataTable
      ...
      Try
         ...
         Dim theFile As FileStream
         Dim ruta As String = HF_RUTA_MASIVA.Value & "CARGA_ASEGURADOS" & "/PROD" & 0 & "/" & sPeriodo & "/POL" & 0 & "-" & sSecPol.ToString.PadLeft(2, "0") & ".LOG"
    ...
    Protected Sub btnSiguientePaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSiguientePaso1.Click
        ...
        Try
            If StatusSession() Then
                ...
                txtReg3.Text = Metodos.Lista_Tabla_CARGA02(Metodos.DB.ORACLE).Compute("count(NUM_REGISTRO)", "")
   ...
   Protected Sub btnCorrectosPaso1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCorrectosPaso1.Click
        Try
            If StatusSession() Then
                ...
                dt = Metodos.Lista_Tabla_CARGA02(Metodos.DB.ORACLE)
   ...
   Private Sub Carga_Masiva_89()
      Try
         ...
         If HF_TIPO.Value = "M" Then
            Metodos.Cierra_Ciclo(Metodos.DB.ORACLE, "CARGA_ASEGURADOS", 0, txtAño3.Text.Trim & ddlMeses.SelectedValue, sCiclo)
