<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProcesosSCTR_Emi.aspx.vb" Inherits="ProcesosSCTR_Emi" 
    MasterPageFile="~/MasterPage.master"   Theme="Tema" Title="Generación de Pólizas Matriz" %>
          ...
          <table style="width: 70%; height: 100%;" border="0">
              <tr>
                  <td colspan="6">
                      <asp:Label ID="txtTitulo" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="11pt"
                          Text="Generación de Póliza Matriz" ForeColor="Green"></asp:Label>
                  </td>
              </tr>
              <tr>
                  <td colspan="6"></td>
                  ...
                  <td colspan="3">
                      <table style="width: 90%; height: 100%; background-color: gainsboro" border="0">
                          ...
                          <tr>
                              ...
                              <td style="width: 20%; text-align: center;">
                                  <asp:Button ID="btnResumen" runat="server" TabIndex="8" Text="Resumen" Width="90%" Enabled="False" /><br />
              ...
              <caption>
                  ...
                  <tr>
                      <td colspan="6">
                          <br/>
                          <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Underline="true" Font-Names="Tahoma" Font-Size="9pt" ForeColor="Gray" Text="Módulos configurados para la emisión"></asp:Label>                          
                      </td>
                  </tr>
                  <tr>
                      <td colspan="3"></td>
                      <td colspan="3">
                          <br/>                         
                          <asp:GridView ID="gbModulo" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
